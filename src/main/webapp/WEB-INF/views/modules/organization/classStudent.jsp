        ...
        <div class="layui-card-body table-tool-mini full-table">
            <div class="layui-form toolbar">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        批量上传用户<a href="/uploads/files/users.xlsx">(模板下载)</a>
...
<script>
    layui.use(['layer', 'form', 'upload', 'table', 'util', 'admin', 'xmSelect'], function () {
        ...
        var insTb = table.render({
            elem: '#tableUser',
            url: '/org/classInfo/studentList.json/'+${classInfo.id},
            page: true,
            toolbar: true,
            cellMinWidth: 100,
            cols: [[
        ...
        upload.render({ //允许上传的文件后缀
            elem: '#test3'
            , url: '${ctx}/org/classInfo/uploadStudent/'+${classInfo.id} //改成您自己的上传接口
            , accept: 'file' //普通文件
