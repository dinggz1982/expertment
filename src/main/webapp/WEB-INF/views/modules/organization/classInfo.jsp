...
<html>
    ...
    <body>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline mr0">
                                    <input name="name" class="layui-input" type="text" placeholder="输入班级名称"/>
                                </div>
                            </div>
                            <div class="layui-inline">
                            ...
                            <div class="layui-inline" style="padding-right: 110px;">
                                ...
                                <button id="btnAddClassInfo" class="layui-btn icon-btn"><i
        ...
        <script type="text/html" id="tableBarClassInfo">
            ...
            <%--            <a class="layui-btn layui-btn-xs" lay-event="classMembers">查看班级成员</a>--%>
        </script>
        <!-- 表格状态列 -->
        <script type="text/html" id="tableStateClassInfo">
            <input type="checkbox" lay-filter="ckStateClassInfo" value="{{d.userId}}" lay-skin="switch"
        ...
        <script type="text/html" id="modelClassInfo">
            <form id="modelClassInfoForm" lay-filter="modelClassInfoForm" class="layui-form model-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="collegeId" id="collegeId" lay-filter="changeCollege">
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="name" id="name" placeholder="请输入班级名称" type="text" class="layui-input"
                               maxlength="20"
        ...
        <script>
            layui.use(['layer', 'form', 'table', 'util', 'admin', 'xmSelect'], function () {
                ...
                table.on('tool(tableClassInfo)', function (obj) {
                    ...
                    } else if (layEvent === 'classMembers') { // 重置密码
                        //新开一个页面
                        layui.use(['index'], function () {
                            var index = layui.index;
                            index.openTab({
                                title: '班级' + data.name + '详细情况',
                                url: '/org/classInfo/' + data.id,
                                end: function () {
                                }
                            });
                        });
                ...
                function showEditModel(mClassInfo) {
                    admin.open({
                        type: 1,
                        title: (mClassInfo ? '修改' : '添加') + '班级',
                        content: $('#modelClassInfo').html(),
                        success: function (layero, dIndex) {
                            $(layero).children('.layui-layer-content').css('overflow', 'visible');
                            var url = "/org/classInfo/saveOrUpdate";//新增或修改用户
                            form.val('modelClassInfoForm', mClassInfo);
                            // 禁止弹窗出现滚动条
                            $(layero).children('.layui-layer-content').css('overflow', 'visible');
                            //mClassInfo.roleIds = insRoleSel.getValue();
                            ...
                            form.on('select(changeCollege)', function (data) {
                                // alert();
                                $('#majorId').empty();
                                $.post('/org/major/getMajorByCollegeId', {
                ...
                // 修改用户状态
                form.on('switch(ckStateClassInfo)', function (obj) {
                    layer.load(2);
                    $.get('../../json/ok.json', {
