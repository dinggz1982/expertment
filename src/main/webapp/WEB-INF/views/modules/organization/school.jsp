        ...
        <script type="text/html" id="modelSchool">
            <form id="modelSchoolForm" lay-filter="modelSchoolForm" class="layui-form model-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="attention" placeholder="请输入联系人" type="text" class="layui-input" maxlength="20"
                               lay-verType="tips" lay-verify="required" required/>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="tel" placeholder="请输入联系电话" type="text" class="layui-input" maxlength="20"
                               lay-verType="tips" lay-verify="required" required/>
                    </div>
                </div>
            ...
            layui.use(['layer', 'form', 'table', 'util', 'admin'], function () {
                ...
                var insTb = table.render({
                    ...
                    cols: [[
                        ...
                        {field: 'attention', sort: true, title: '联系人'},
                ...
                function showEditModel(mSchool) {
                    admin.open({
                        ...
                        success: function (layero, dIndex) {
                            ...
                            var url = '${ctx}/org/school/saveOrUpdate';
                            // 回显数据
