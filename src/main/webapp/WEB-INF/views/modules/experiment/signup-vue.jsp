                                ...
                                <el-col :span="22">
                                    <el-row type="flex" justify="start" align="middle">
                                        ...
                                        <el-select style="width: 160px;margin-left: 10px;" v-model="applyType"
                                                   @change="statusSelectChange" clearable
                                                   placeholder="请选择实验类型">
                        ...
                        getLabRecordList(id) {
                            ...
                            c.get(url, res => {
                                ...
                                if (res.code === 0) {
                                    ...
                                    console.log('this.labRecordList ,', this.labRecordList)
                                    if (this.labRecordList.length > 0) {
                                        this.labRecordList.forEach(item => {
                                            console.log('item', item)
                                            if (item.num - item.alreadyNum <= 0) {
                                                console.log('item.num - item.alreadyNum <= 0')
                                                console.log('item.num - item.alreadyNum <= 0 res:', item.num - item.alreadyNum)
                                                item.disable = true
                                                return;
                                            }
