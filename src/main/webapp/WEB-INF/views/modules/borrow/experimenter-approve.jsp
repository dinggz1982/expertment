                                                ...
                                                <el-table-column align="center" label="操作">
                                                    <template slot-scope="scope">
                                                        <el-button @click="approve('lab',scope.row)" size="mini"
                                                                   v-if="scope.row.status===2" type="primary"> 审核
                                                        </el-button>
                                                    </template>
                                                </el-table-column>
                                            </el-table>
            ...
            layui.use(['layer', 'index'], function () {
                ...
                var vue = new Vue({
                    ...
                    methods: {
                        ...
                        submitConfirm() {
                            let url = '/borrow/experimenter/approve/submitApprove'
                            let _that = this
                            c.ajax({
                                url: url,
                                type: 'post',
                        ...
                        getInstrumentApproveList() {
                            let url = '/borrow/experimenter/approve/getInstrumentApproveList'
                            c.get(url, {
                        ...
                        getLabApproveList() {
                            let url = '/borrow/experimenter/approve/getLabApproveList'
                            c.get(url, {
