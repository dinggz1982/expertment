...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container">
        <div class="header-container d-flex align-items-center justify-content-between">
            <div class="logo">
                <h1 class="text-light"><a href="/index_innovation"><span>创新实践</span></a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="index#about">实验室介绍</a></li>
                    ...
                    <li><a class="nav-link scrollto active" href="/index_innovation">创新实践</a></li>
...
<main id="main">
    ...
    <section id="testimonials" class="testimonials section-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-8" id="innovation" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <p>
                                        ...
                                        正在建设中--------正在建设中---------正在建设中---------正在建设中
                                       <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                    <img src="assets/images/kaifa.jpg" class="testimonial-img" alt="">
                                </div>
