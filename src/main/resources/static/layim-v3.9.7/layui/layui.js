...
;!function (t) {
    ...
    r.prototype.cache = n, r.prototype.define = function (t, e) {
    ...
    }, r.prototype.use = function (t, r, c) {
        function l(t, e) {
            var r = "PLaySTATION 3" === navigator.platform ? /^complete$/ : /^(complete|loaded)$/;
            ("load" === t.type || r.test((t.currentTarget || t.srcElement).readyState)) && (n.modules[d] = e, y.removeChild(m), function o() {
                return ++v > 1e3 * n.timeout / 4 ? a(d + " is not a valid module") : void (n.status[d] ? s() : setTimeout(o, 4))
            }())
        }

        function s() {
            c.push(layui[d]), t.length > 1 ? p.use(t.slice(1), r, c) : "function" == typeof r && r.apply(layui, c)
        }

        var p = this, f = n.dir = n.dir ? n.dir : o, y = e.getElementsByTagName("head")[0];
        t = "string" == typeof t ? [t] : t, window.jQuery && jQuery.fn.on && (p.each(t, function (e, n) {
            "jquery" === n && t.splice(e, 1)
        }), layui.jquery = layui.$ = jQuery);
        var d = t[0], v = 0;
        if (c = c || [], n.host = n.host || (f.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === t.length || layui["layui.all"] && u[d]) return s(), p;
        ...
        if (h = h.replace(/^\{\/\}/, ""), !n.modules[d] && layui[d] && (n.modules[d] = h), n.modules[d]) !function g() {
            return ++v > 1e3 * n.timeout / 4 ? a(d + " is not a valid module") : void ("string" == typeof n.modules[d] && n.status[d] ? s() : setTimeout(g, 4))
        }(); else {
        ...
        var i = this, u = e.createElement("link"), c = e.getElementsByTagName("head")[0];
        "string" == typeof r && (o = r);
        var l = (o || t).replace(/\.|\//g, ""), s = u.id = "layuicss-" + l, p = 0;
        return u.rel = "stylesheet", u.href = t + (n.debug ? "?v=" + (new Date).getTime() : ""), u.media = "all", e.getElementById(s) || c.appendChild(u), "function" != typeof r ? i : (function f() {
        ...
        var e = this;
        t = t || {};
        for (var n in t) e[n] || e.modules[n] ? a(n + " Module already exists") : e.modules[n] = t[n];
        return e
        ...
        var a = this, i = null, u = (e || "").match(/\((.*)\)$/) || [], c = (t + "." + e).replace(u[0], ""),
            l = u[1] || "", s = function (t, e) {
                var n = e && e.call(a, r);
                n === !1 && null === i && (i = !1)
            };
        return "LAYUI-EVENT-REMOVE" === r ? (delete (a.cache.event[c] || {})[l], a) : o ? (n.event[c] = n.event[c] || {}, n.event[c][l] = [o], this) : (layui.each(n.event[c], function (t, e) {
            return "{*}" === l ? void layui.each(e, s) : ("" === t && layui.each(e, s), void (l && t === l && layui.each(e, s)))
        }), i)
